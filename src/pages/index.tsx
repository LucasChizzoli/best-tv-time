    ...
    <div className="h-screen w-screen flex flex-col justify-center items-center bg-gray-800 text-white text-center">
      ...
      {dogPair && (
        <div className="mt-5 flex justify-between max-w-2xl">
          <div className="w-200">
            <Image src={dogPair.firstDog.imageUrl ? dogPair.firstDog.imageUrl : '/image-placeholder.png'} alt={dogPair.firstDog.name} height="200" width="200" />
          ...
          <div className="w-200">
          <Image src={dogPair.secondDog.imageUrl ? dogPair.secondDog.imageUrl : '/image-placeholder.png'} alt={dogPair.secondDog.name} height="200" width="200" />
      ...
      <div className="w-full text-xl text-center pb-2 mt-9">
        ...
        <div className="mt-5">
          <a className="underline hover:text-gray-400" href="https://twitter.com/LChizzoli">Twitter</a>
        </div>
      </div>
    </div>
  )
